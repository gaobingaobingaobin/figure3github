    function  L= lagrangePi00(p_Variable,p_00Vec,p_01Vec,p_10Vec,p_11Vec...
                ,PHvec,gVec1,gVec2,hVec,I1,I2,lambdaVec,betaVec,PavVec,channelNum,ST)
            %只有p_variable是真正的变量
    ...
    %PavVec=[Pav1,Pav2,Pav3,Pav4,Pav5], 5 ST的功率上限
    ...
    tempSUM=P1H0.*P2H0.*p_00+P1H0.*P2H1.*p_01+P1H1.*P2H0.*p_10+...
           P1H1.*P2H1.*p_11;
    L = -P1H0.*P2H0.*log(1+h.*p_variable)-lambda.*P1H0.*P2H0.*p_variable...
        +beta./2 .* (tempSUM-P1H0.*P2H0.*p_00...
        +P1H0.*P2H0.*p_variable-Pav ).^2;
    end